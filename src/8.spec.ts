import { array_of_functions } from './8'
...
describe('compress list_5', () => {

  it('should return [1, 2, 3, 4, 3, 2, 1, 2]', () => {
    for (let f of array_of_functions) {
      let res = f(list_5);
      expect(res).to.deep.equal([1, 2, 3, 4, 3, 2, 1, 2])
    }
  })
