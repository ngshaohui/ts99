import { array_of_functions } from './15'
...
describe('repli list_2', () => {

  it('should return [4, 4, 4, 2, 2, 2, 5, 5, 5, 2, 2, 2, 4, 4, 4]', () => {
    for (let f of array_of_functions) {
      let res = f(list_2, 3);
      expect(res).to.deep.equal([4, 4, 4, 2, 2, 2, 5, 5, 5, 2, 2, 2, 4, 4, 4])
    }
  })
